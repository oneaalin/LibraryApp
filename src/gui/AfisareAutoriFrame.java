...
public class AfisareAutoriFrame extends JFrame{

    AfisareAutoriFrame(BibliotecaCtrl bibliotecaGUI){

        String[] columns = new String[] {
                "ID","Titlu","Autori","Anul Aparitiei","Pret","Editura","Cota"
        };

        String autor = JOptionPane.showInputDialog("Ce autor vrei sa cauti? : ");

        Object[] carti = bibliotecaGUI.getCartiByAutor(autor);
